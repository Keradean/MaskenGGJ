...
public class InputManager : MonoBehaviour
{
    ...
    public bool MeleeWasPressed => meleeAction.WasPressedThisFrame(); 
    ...
    private void Awake()
    {
        ...
        meleeAction = mapReference.FindAction(melee); 
    ...
    private void SetupCallbacks()
    {
        ...
        meleeAction.performed += ctx => MeleeTriggered = true;
        meleeAction.canceled += ctx => MeleeTriggered = false;
