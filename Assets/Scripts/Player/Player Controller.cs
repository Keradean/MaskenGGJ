...
public class PlayerController : MonoBehaviour
{
    ...
    {
        // Linksklick = Einzelschuss
        if (inputManager.ShootWasPressedThisFrame && weaponsManager != null)
        {
    ...
    {
        // Rechtsklick = Nahkampf
        if (inputManager.MeleeWasPressed && weaponsManager != null)
        {
            weaponsManager.MeleeAttack();
        }
    }
